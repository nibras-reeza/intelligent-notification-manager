...
/**
 * A list fragment representing a list of Days. This fragment also supports
...
public class DayListFragment extends ListFragment
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setListAdapter(new DaysAdapter(getActivity()));
	}
			...
			long id)
	{
		...
		mCallbacks.onDaySelect(Days.ITEMS.get(position).number);
	}
